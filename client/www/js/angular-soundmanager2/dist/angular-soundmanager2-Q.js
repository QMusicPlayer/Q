    ...
    function($rootScope, $log) {
        ...
        return {
            ...
            addTrack: function(track) {
                ...
                console.log(playlist, 'adding track')
                return track.id;
            },
            ...
            link: function(scope, element, attrs) {
                ...
                socket.on('getQueue', function (queue) {
                    ...
                    if(queue !== null) {
                      ...
                      angularPlayer.sortByVotes(true);
                    }
                });

                socket.on('playSong', function() {
                  angularPlayer.setCurrentSong();
                })
                ...
                scope.$on('track:progress', function(event, data) {
                    socket.emit('currentlyPlayingToServer', angularPlayer.currentTrackData());
                });
...
ngSoundManager.directive('skipSong', ['angularPlayer', '$rootScope', function (angularPlayer, $rootScope) {
    return {
        restrict: "EA",
        scope: {
            song: "=skipSong"
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                element.bind('click', function(event) {
                    ...
                    socket.emit('deleteSongFromDb', {song: scope.song, index: attrs.index});
                });
            }
        };
    }
